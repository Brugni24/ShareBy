            ...
            <div class="flex flex-col gap-4 w-[80vw] m-auto pt-[30px] md:w-[45rem]">
                ...
                <div id="faq" class="w-full border border-white/40 rounded-xl hover:bg-slate-950 cursor-pointer py-5 px-6">
                    <div id="question" class="flex justify-between items-center">
                        <h3 class="text-lg font-medium text-white w-[90%] mr-[15px]">
                            Su cosa si basa la nostra analisi aziendale?
                        </h3>
                        <div id="plus-minus-svg" class="w-[24px] aspect-square rounded-full border-2 border-primary flex justify-center items-center">
                    ...
                    <div id="answer" class="max-h-0 overflow-hidden transition-all duration-700 ease-[cubic-bezier(.215, .61, .355, 1)]">
                        <p class="text-left py-5">
                            L'analisi finanziaria si basa su tre tipologie di analisi: analisi di redditività, analisi sull'indebitamento e analisi sulla struttura patrimoniale. 
                            Inoltre, offriamo agli investitori e agli appassionati di finanza accesso ad analisi approfondite su titoli, mercati e settori specifici. 
                            Queste analisi vengono create da alcuni algoritmi proprietari che sfruttano l'intelligenza artificiale per elaborare i risultati finali.
                        </p>
                    </div>
                </div>
                {{-- 2° domanda --}}
                <div id="faq" class="w-full border border-white/40 rounded-xl hover:bg-slate-950 cursor-pointer py-5 px-6">
                    <div id="question" class="flex justify-between items-center">
                        <h3 class="text-lg font-medium text-white w-[90%] mr-[15px]">
                            Quali benefici posso ottenere sottoscrivendo il vostro servizio di analisi finanziaria?
                        </h3>
                        <div id="plus-minus-svg" class="w-[24px] aspect-square rounded-full border-2 border-primary flex justify-center items-center">
                            <div id="line_1" class="w-3 h-[2px] rounded-xl bg-primary transition-all duration-700 ease-in-out"></div>
                            <div id="line_2" class="w-[2px] h-3 bg-primary absolute transition-all duration-700 ease-in-out"></div>
                    ...
                    <div id="answer" class="max-h-0 overflow-hidden transition-all duration-700 ease-[cubic-bezier(.215, .61, .355, 1)]">
                        <p class="text-left py-5">
                            Sottoscrivendo il nostro servizio di analisi finanziaria, avrai accesso a informazioni cruciali per prendere decisioni 
                            consapevoli sugli investimenti. Potrai ricevere raccomandazioni su azioni, obbligazioni, fondi comuni e altri veicoli 
                            di investimento, oltre a report regolari sulle prestazioni del tuo portafoglio. Inoltre, avrai l'opportunità di 
                            interagire con PYLO, il nostro esperto finanziario virtuale per risolvere qualsiasi tipo di dubbio e ottenere consigli personalizzati.
                        </p>
                    </div>
                </div>
                {{-- 3° domanda --}}
                <div id="faq" class="w-full border border-white/40 rounded-xl hover:bg-slate-950 cursor-pointer py-5 px-6">
                    <div id="question" class="flex justify-between items-center">
                        <h3 class="text-lg font-medium text-white w-[90%] mr-[15px]">
                            Quali sono i costi associati alla sottoscrizione del vostro servizio?
                        </h3>
                        <div id="plus-minus-svg" class="w-[24px] aspect-square rounded-full border-2 border-primary flex justify-center items-center">
                            <div id="line_1" class="w-3 h-[2px] rounded-xl bg-primary transition-all duration-700 ease-in-out"></div>
                            <div id="line_2" class="w-[2px] h-3 bg-primary absolute transition-all duration-700 ease-in-out"></div>
                    ...
                    <div id="answer" class="max-h-0 overflow-hidden transition-all duration-700 ease-[cubic-bezier(.215, .61, .355, 1)]">
                        <p class="text-left py-5">
                            I costi di sottoscrizione variano in base al piano che scegli. Offriamo diverse opzioni di abbonamento per adattarci 
                            alle tue esigenze. I dettagli sui costi e sui piani sono disponibili nella sezione "Piani di Sottoscrizione" del nostro sito web. 
                            Inoltre, offriamo spesso promozioni e periodi di prova gratuiti, quindi ti consigliamo di controllare regolarmente il nostro 
                            sito web per le offerte più recenti.
                        </p>
                    </div>
                </div>
            </div>
