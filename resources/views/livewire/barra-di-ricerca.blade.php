<form action="{{ url('company.search') }}" method="GET" role="search">   
    ...
    <div class="relative">
        ...
        <input wire:model="term" type="search" name='search' value="" id="default-search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Cerca le aziende ..." required>
    </div>
