...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased font-main bg-secondary">
        {{-- navbar --}}
        <nav class="flex justify-between md:justify-center items-center w-full h-[70px] bg-secondary py-[10px] px-[24px] shadow-xl lg:px-[35px]">
            {{-- logo --}}
            ...
            <div class="hidden md:flex md:w-full font-medium text-lg flex-row justify-evenly items-center">
            ...
            {{-- menu --}}
            <div class="flex items-center sm:pt-0 md:order-2 md:w-[230px] md:justify-end">
                @if (Route::has('login'))
                    @auth
